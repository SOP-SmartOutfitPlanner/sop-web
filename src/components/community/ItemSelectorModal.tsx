...
export function ItemSelectorModal({
  ...
  const selectedCategory = preSelectedCategoryId;
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-6xl max-h-[90vh] p-0 gap-0 backdrop-blur-xl bg-gradient-to-br from-cyan-950/60 via-blue-950/50 to-indigo-950/60 border-2 border-cyan-400/25 shadow-2xl shadow-cyan-500/20">
        <DialogHeader className="px-6 py-4 border-b border-cyan-400/10">
          ...
          <p className="text-sm text-white/60 mt-1">
            {description ||
              `${localSelectedIds.length} / ${maxSelection} items selected`}
          </p>
        </DialogHeader>
