            ...
            return (
              <div key={index} className="flex flex-col">
                ...
                <button
                  ...
                  className={`
                    relative flex-1 min-h-[400px] p-3 rounded-xl transition-all duration-300 border-2
                    ${
                      isCurrentDay
                    ...
                    <div className="space-y-2 h-full overflow-y-auto">
                      {dayInfo.entries.slice(0, 2).map((entry, idx) => {
                        ...
                        return (
                          <div
                            key={idx}
                            className="bg-white/10 rounded-lg overflow-hidden border border-white/20 hover:border-white/30 transition-all"
                          >
                            {/* Occasion Header */}
                              ...
                              <div className="p-2">
                                ...
                                <div className="text-center">
                                  ...
                                  <p className="text-[9px] text-white/50">
                                    {firstOutfit.outfitDetails.items.length}{" "}
                                    items
                                  </p>
                                </div>
