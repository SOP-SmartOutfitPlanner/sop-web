...
import { X, Plus, Check, CheckCircle2, Sparkles } from "lucide-react";
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="font-bricolage text-lg text-gray-200 mt-2">
                    Select items from your wardrobe and give your outfit a name
                  </p>
                </div>
                <button
                  onClick={handleClose}
                  ...
                  >
                    {isPending ? (
                      ...
                      <>
                        ...
                        Create Outfit ({selectedItemIds.length})
                      </>
                    )}
                  </GlassButton>
                </div>
