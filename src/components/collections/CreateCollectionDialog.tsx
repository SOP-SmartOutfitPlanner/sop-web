...
export function CreateCollectionDialog({
  ...
  const validation = useMemo(
    () => ({
      ...
      thumbnail: !thumbnailFile ? "Thumbnail image is required" : null,
      outfits:
        selectedOutfits.size === 0
          ? "Please select at least one outfit"
          : null,
    }),
    [title, thumbnailFile, selectedOutfits.size]
  );

  const isFormValid =
    title.trim().length > 0 && thumbnailFile && selectedOutfits.size > 0;
  ...
  const createMutation = useMutation({
    mutationFn: async () => {
      ...
      return collectionAPI.createCollection(formData);
    },
    onSuccess: () => {
          ...
          <div className="w-[40%] flex flex-col border-r border-slate-700/50 bg-gradient-to-b from-slate-900/50 to-slate-900/40 backdrop-blur-sm">
            ...
            <div className="p-6 border-b border-slate-700/50 bg-gradient-to-r from-slate-900/80 to-slate-800/60">
              ...
              <p className="text-sm text-slate-400 mt-2">
                Fill in the details and select outfits for your collection
              </p>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    <p className={cn(
                      ...
                      shortDescription.length > 180 ? "text-amber-400" : "text-slate-400"
                    )}>
              ...
              <div className="space-y-5">
                ...
                {validation.thumbnail && (
                  <div className="flex items-center gap-1.5 text-xs text-rose-400 mt-2 animate-in fade-in slide-in-from-top-1">
                    <AlertCircle className="h-3.5 w-3.5" />
                    <span>{validation.thumbnail}</span>
                  </div>
                )}
              </div>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <Button
                  ...
                  className={cn(
                    ...
                    isFormValid && "hover:scale-[1.02] hover:shadow-xl hover:shadow-cyan-500/30"
                  )}
                >
                              ...
                              <div className="relative w-full h-full">
                                <Image
                                  ...
                                  className={cn(
                                    ...
                                    isSelected ? "scale-105 brightness-125" : "group-hover:scale-110 group-hover:brightness-115"
                                  )}
                                />
                                <div className={cn(
                                  "absolute inset-0 transition-opacity duration-300",
                                  isSelected ? "bg-cyan-500/10" : "bg-transparent group-hover:bg-cyan-500/5"
                                )} />
                              </div>
                            ) : (
                            ...
                            {isSelected && (
                              <div className="mt-3 pt-3 border-t border-slate-700/50 animate-in slide-in-from-top-2 fade-in duration-300">
                                <label className="text-xs font-medium text-slate-300 mb-1.5 block">
                                  Outfit Description <span className="text-slate-500">(Optional)</span>
                                </label>
                                <Textarea
